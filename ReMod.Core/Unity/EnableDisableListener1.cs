...
namespace ReMod.Core.Unity
{
    ...
    public class EnableDisableListener1 : MonoBehaviour
    {
        ...
        public EnableDisableListener1(IntPtr obj) : base(obj) { }
        ...
        public static void RegisterSafe()
        {
            ...
            try
            {
                ClassInjector.RegisterTypeInIl2Cpp<EnableDisableListener1>();
                _registered = true;
            }
            catch (Exception)
            {
